...
object SunCalculator {
    ...
    fun calculate(
        ...
        // Derive UTC-offset hours from the current system timezone offset for today
        val now = Clock.System.now()
        val tz = TimeZone.currentSystemDefault()
        val offsetSeconds = tz.offsetAt(now).totalSeconds
        val timezone = offsetSeconds / 3600.0
        ...
        val zenith = 90.833 * PI / 180.0 // Official sunrise/sunset
